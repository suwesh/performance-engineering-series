...
def chatbot_kb_retriever(sentences, rag_resources):
    ...
    search_profiler.dump_stats("/home/suwesh/Projects/chatbot_kb_retrieval/profiling_evidences/faiss_threadpool_controlled.prof")
    search_end = time.perf_counter()
    print(f"controlled faiss internal threading, FAISS searches Stage (with external multithreading): {search_end - search_start:.6f}s")
